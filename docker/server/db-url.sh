...
resolve_database_url() {
    ...
    # the database with a publicly-known password (the literal `change-me-...`
    # example value) is a credential leak, so fail fast unless this is a
    # non-production run. NODE_ENV defaults to production in the image, so an
    # unset NODE_ENV is treated as production.
