...
export const VRL_SNIPPETS: VrlSnippet[] = [
  // ── Parsing ──────────────────────────────────────────
  { id: "parse-json", name: "parse_json", description: "Parse a JSON string into an object", category: "Parsing", code: '. = parse_json!(.message)', placeholders: [".message"] },
  { id: "parse-syslog", name: "parse_syslog", description: "Parse a syslog-formatted message", category: "Parsing", code: '. = parse_syslog!(.message)', placeholders: [".message"] },
  ...
  { id: "parse-key-value", name: "parse_key_value", description: "Parse key=value pairs from a string", category: "Parsing", code: '. = parse_key_value!(.message)', placeholders: [".message"] },
  { id: "parse-regex", name: "parse_regex", description: "Extract fields using a named-capture regex", category: "Parsing", code: ". = parse_regex!(.message, r'^(?P<timestamp>\\S+) (?P<level>\\w+) (?P<msg>.*)$')", placeholders: [".message"] },
  { id: "parse-grok", name: "parse_grok", description: "Parse a string using a Grok pattern", category: "Parsing", code: '. = parse_grok!(.message, "%{COMBINEDAPACHELOG}")', placeholders: [".message", "%{COMBINEDAPACHELOG}"] },
  ...
  { id: "parse-apache-log", name: "parse_apache_log", description: "Parse an Apache combined log format line", category: "Parsing", code: '. = parse_apache_log!(.message, format: "combined")', placeholders: [".message"] },
  { id: "parse-nginx-log", name: "parse_nginx_log", description: "Parse an Nginx combined log format line", category: "Parsing", code: '. = parse_nginx_log!(.message, format: "combined")', placeholders: [".message"] },
  ...
  { id: "only-fields", name: "only_fields", description: "Keep only specified fields, remove everything else", category: "Filtering", code: 'only_fields(., ["message", "timestamp", "host"])', placeholders: ["message", "timestamp", "host"] },
